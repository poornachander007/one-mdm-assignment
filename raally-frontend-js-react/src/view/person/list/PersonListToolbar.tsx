    ...
    if (disabled) {
      return (
        <span
          ...
          data-for="person-list-toolbar-export-tooltip"
        >
          {button}
          <ReactTooltip id="person-list-toolbar-export-tooltip" />
        </span>
      );
    }
    ...
    if (disabled) {
      return (
        <span
          ...
          data-tip-disable={!disabled}
          data-for="person-list-toolbar-destroy-tooltip"
        >
          {button}
          <ReactTooltip id="person-list-toolbar-destroy-tooltip" />
        </span>
      );
    }
  ...
  return (
    <Toolbar>
      ...
      {hasPermissionToAuditLogs && (
        <Link to="/audit-logs?entityNames=person">
