...
function AssignmentToolbar(props) {
  const [
  ...
  const hasPermissionToCreate = useSelector(
    assignmentSelectors.selectPermissionToCreate,
  );
  const hasPermissionToImport = useSelector(
    assignmentSelectors.selectPermissionToImport,
  );
    ...
    if (disabled) {
      return (
        <span
          ...
          data-for="assignment-list-toolbar-export-tooltip"
        >
          {button}
          <ReactTooltip id="assignment-list-toolbar-export-tooltip" />
        </span>
      );
    }
    ...
    if (disabled) {
      return (
        <span
          ...
          data-tip-disable={!disabled}
          data-for="assignment-list-toolbar-destroy-tooltip"
        >
          {button}
          <ReactTooltip id="assignment-list-toolbar-destroy-tooltip" />
        </span>
      );
    }
  ...
  return (
    <Toolbar>
      ...
      {hasPermissionToAuditLogs && (
        <Link to="/audit-logs?entityNames=assignment">
