...
function JobTitleToolbar(props) {
  const [
  ...
  const hasPermissionToCreate = useSelector(
    jobTitleSelectors.selectPermissionToCreate,
  );
  const hasPermissionToImport = useSelector(
    jobTitleSelectors.selectPermissionToImport,
  );
    ...
    if (disabled) {
      return (
        <span
          ...
          data-for="job-title-list-toolbar-export-tooltip"
        >
          {button}
          <ReactTooltip id="job-title-list-toolbar-export-tooltip" />
        </span>
      );
    }
    ...
    if (disabled) {
      return (
        <span
          ...
          data-tip-disable={!disabled}
          data-for="job-title-list-toolbar-destroy-tooltip"
        >
          {button}
          <ReactTooltip id="job-title-list-toolbar-destroy-tooltip" />
        </span>
      );
    }
  ...
  return (
    <Toolbar>
      ...
      {hasPermissionToAuditLogs && (
        <Link to="/audit-logs?entityNames=jobTitle">
